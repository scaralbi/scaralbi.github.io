...
Another reason is to engineer organisms to perform functions that they would not perform naturally. With this approach, we can programm bacteria to identify and kill cancerous cells. Or we can make hydrogen out of algae instad of using nasty chemicals and polluting the environment. 
